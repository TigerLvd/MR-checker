...
/**
 * Общее исключение для ошибок процесса проверки MR.
 * Содержит информацию о HTTP статусе, коде ошибки и времени возникновения.
 */
@Getter
public class MRCheckException extends RuntimeException {
     ...
     */
    public MRCheckException(String message) {
        super(message);
        this.httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
        this.errorCode = "MR_CHECK_ERROR";
     ...
     */
    public MRCheckException(String message, Throwable cause) {
        super(message, cause);
        this.httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
        this.errorCode = "MR_CHECK_ERROR";
        this.timestamp = Instant.now();
     ...
     */
    public MRCheckException(String message, HttpStatus httpStatus) {
        super(message);
     ...
     * @param httpStatus HTTP статус ошибки
     */
    public MRCheckException(String message, Throwable cause, HttpStatus httpStatus) {
        super(message, cause);
        this.httpStatus = httpStatus;
        this.errorCode = "MR_CHECK_ERROR";
        this.timestamp = Instant.now();
     ...
     */
    public MRCheckException(String message, Throwable cause, HttpStatus httpStatus, String errorCode) {
        super(message, cause);
        this.httpStatus = httpStatus;
